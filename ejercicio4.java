...
public class ejercicio4 {
    ...
    public static void main(String[] args) {
        ...
        String nombreArchivo = "ruta/al/archivo.txt";

        // Llamada a la función para obtener estadísticas
        try {
    ...
    public EstadisticasTexto(int numLineas, int numPalabras, int numCaracteres, List<String> palabras) {
